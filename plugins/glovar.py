...
project_link: str = ""
project_name: str = ""
threshold_drawings: float = 0
threshold_drawings_hentai: float = 0
threshold_hentai: float = 0
...
try:
    ...
    threshold_drawings = float(config["custom"].get("threshold_drawings", threshold_drawings))
    threshold_drawings_hentai = float(config["custom"].get("threshold_drawings_hentai", threshold_drawings_hentai))
    threshold_hentai = float(config["custom"].get("threshold_hentai", threshold_hentai))
...
if (bot_token in {"", "[DATA EXPUNGED]"}
        ...
        or threshold_drawings == 0
        or threshold_drawings_hentai == 0
        or threshold_hentai == 0
        or threshold_porn == 0
        or time_ban == 0
        or time_new == 0
        or time_punish == 0
...
lang: Dict[str, str] = {
    ...
    "model_recheck": (zh_cn and "复查模型") or "Recheck Model",
    "drawings": (zh_cn and "普通绘画") or "Drawings",
    "hentai": (zh_cn and "色情绘画") or "Hentai",
    "neutral": (zh_cn and "正常图片") or "Neutral",
    "porn": (zh_cn and "色情图片") or "Porn",
    "sexy": (zh_cn and "性感图片") or "Sexy"
}

# Init

all_commands: List[str] = ["config", "config_recheck", "version"]
