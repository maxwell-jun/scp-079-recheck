...
from .etc import get_now, get_links, get_md5sum, get_text, thread
    ...
    try:
        ...
        if not image_path:
            ...
            if image_path and image_hash and image_hash not in glovar.except_ids["temp"]:
                ...
                # Get porn score
                porn_a = get_porn_a(image_path)
                porn_b = get_porn_b(image_path)
                if porn_a and porn_b:
                    if (porn_b["hentai"] > glovar.threshold_drawings_hentai
                            or (porn_a["hentai"] > glovar.threshold_hentai
                                and porn_b["drawings"] < glovar.threshold_drawings
                                and porn_b["drawings"] + porn_b["hentai"] > glovar.threshold_drawings_hentai)):
                        return "nsfw"
                    elif porn_a["porn"] + porn_b["porn"] + porn_a["sexy"] + porn_b["sexy"] > glovar.threshold_porn:
                        return "nsfw"
